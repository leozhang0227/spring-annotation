...
import com.athangzhou.aop.introduction.EnableSellerAspect;
...
public class MainConfigOfAOPIntro {
	...
	//业务逻辑加入容器
	@Bean
	public NavieWaiter navieWaiter()
	{
		return new NavieWaiter();
	}
	
	@Bean
	public SmartSeller smartSeller()
	{
		return new SmartSeller();
	}
	//切面类也加入容器
	@Bean
	public EnableSellerAspect enableSellerAspect() {
